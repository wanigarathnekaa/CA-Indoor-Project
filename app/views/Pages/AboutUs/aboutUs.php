...
<head>
  ...
  <link rel="stylesheet" href="<?php echo URLROOT; ?>/css/AboutUsStyle.css">
...
<header id="header">
<a href="#"><img src="<?php echo URLROOT; ?>/images/logo.png" /></a>
  <ul>
      <li><a href="http://localhost/C&A_Indoor_Project/Pages/LandingPage/User">Home</a></li>
    ...
    <div class="sec">
      ...
      <div class="box">
        ...
        <div class="mainbox">
          ...
          <div>
            <h4>Reservations have to be made through phone calls and to see the booking confirmations on the calendar, please refresh the page</h4>
          </div>
          <br>
          <div class="box2">
            <div>
    ...
    <div class="sec">
      ...
      <div class="box">
        ...
        <div class="mainbox2">
          ...
          <div class="mainbox3">
            <div>
              <h6>Use the event calender to get an idea of reserved dates Contact us to book a time and a date at your convenience</h6>
            </div>
