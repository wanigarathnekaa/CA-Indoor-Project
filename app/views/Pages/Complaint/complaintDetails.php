...
<body>
      ...
      <section class="home">
          ...
          <form id="contact" action="<?php echo URLROOT; ?>/Complaint/sendEmail/<?php echo $data['complaint']->email; ?>" method="post">
            <div class="input-box">
            ...
            <div class="input-box">
                  <textarea id="message" name="message" placeholder="Enter your Reply" value=""></textarea>
            </div>
            <div class="button">
